...
// Views
		...
		u.productPreviewView = n.View.extend({
		  ...
		  afterRender: function() {
				...
				g = new x(document.getElementById("graph"), [[new Date("2009/07/12"), 6.49],[new Date("2009/07/13 12:34:56"), 6.99]], {
					labels: [ "Date", "Price" ],
                     axes: {
                         x: {
                             valueFormatter: x.dateString_,
                             axisLabelFormatter: x.dateAxisFormatter,
                             ticker: x.dateTicker
                         }
                     }					
				});
