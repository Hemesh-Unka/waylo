...
// Views
		...
		u.productPreviewView = n.View.extend({
		  ...
		  afterRender: function() {
				...
				g = new y(document.getElementById("graph"), [[1247382000000, 6.49],[new Date("2009/07/13 12:34:56"), 6.99]], {
					labels: [ "Date", "Price" ],
                     axes: {
                         x: {
                             valueFormatter: y.dateString_,
                             axisLabelFormatter: y.dateAxisFormatter,
                             ticker: y.dateTicker
                         }
                     }					
				});
